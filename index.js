...
Всі на розминку! 🏁`;
    ...
    const TEST_CHAT_ID = '-1003991774520';

    try {
        await bot.telegram.sendMessage(TEST_CHAT_ID, welcomeText, { parse_mode: 'HTML' });
        console.log(`✅ Повідомлення успішно надіслано в чат: ${TEST_CHAT_ID}`);
    } catch (err) {
